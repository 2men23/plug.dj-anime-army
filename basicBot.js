...
(function() {
    ...
    */
    ...
    var loadChat = function(cb) {
        if (!cb) cb = function() {};
        $.get('https://raw.githubusercontent.com/2men23/plug.dj-anime-army/master/basicBot.js', function(json) {
    ...
    var basicBot = {
        ...
        name: 'animefan#1',
        loggedInID: null,
        scriptLink: 'https://raw.githubusercontent.com/2men23/plug.dj-anime-army/master/basicBot.js',
        ...
        settings: {
            botName: 'animefan#1',
            language: 'english',
            chatLink: 'https://raw.githubusercontent.com/2men23/plug.dj-anime-army/master/basicBot.js',
        ...
        chatUtilities: {
            ...
            curses: [
                'nigger', 'faggot', 'nigga', 'niqqa', 'motherfucker', 'modafocka', 'fuck', 'motherfucker',
            ]
        },
        connectAPI: function() {
            this.proxy = {
